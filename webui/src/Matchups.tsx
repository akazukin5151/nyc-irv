...
export function Matchups(props: MatchupsProps) {
  return (
    <section>
      <h2 class="ml-4 pt-2">Pairwise matchups</h2>

      <div class="flex flex-col items-center">
        <div class="mx-auto my-3 h-[70vh] max-w-full overflow-auto rounded-xl bg-white px-4 py-3 shadow-md dark:bg-neutral-800">
          <For each={props.matchups}>
            {([cand1, cand2, v1, v2], idx) => {
              const sum = v1 + v2;
              ...
              const last1 = cand1
                .split(" ")
                .pop() as keyof typeof CANDIDATE_COLORS;
              const last2 = cand2
                .split(" ")
                .pop() as keyof typeof CANDIDATE_COLORS;
              ...
              const text_color_1 = IS_CAND_COLOR_DARK[last1]
                ? "white"
                : "black";
              const text_color_2 = IS_CAND_COLOR_DARK[last2]
                ? "white"
                : "black";
              ...
              return (
                <div class={is_section_end ? "mb-4" : ""}>
                  <svg
                    height="30"
                    width={400 + bar_width}
                    class="mx-auto dark:[&_.axis-label]:fill-white [&_.tick-mark]:stroke-black dark:[&_.tick-mark]:stroke-white"
                  >
                    <g class="[&_text]:text-sm">
                      <line
                        x1={bar_start - 5}
                        y1="15"
                        x2={bar_start}
